# 仕事で手一杯の私が、AIで自分の仕事用自動化ツールを20選から100選に大幅拡張してみた話
...
この記事では、**20選から100選への拡張過程**と、**プログラミング未経験でも、AIを使えば自分の仕事を自動化できる**という体験談をお話しします。
...
### 📈 拡張の背景
最初は20種類の基本的な自動化ツールから始めましたが、**「もっと多くの業務に対応できるツールを作りたい」**という思いが強くなりました。

多くの方から「自分の仕事も自動化できそう」「他にもこんなツールがあればいいのに」という声をいただき、**100選への拡張を決意**しました。

### 🎯 拡張で追加した内容
- **80種類の新しい自動化ツール**を追加
- **カテゴリ別の整理**（メール・スタッフ・顧客管理、データ処理・分析、ファイル・フォルダ管理など）
- **詳細なAIプロンプト例**を全ツールに追加
- **段階的な難易度設定**（初級・中級）
- **実践的なサンプルコード**の充実
