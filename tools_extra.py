...
EXTRA_TOOLS += [
    ...
    },
    {
        ...
        "time_required": "10分〜30分",
        "difficulty": "初級",
        "ai_prompt": "Pythonで顧客誕生日リスト自動作成のコードを作成してください。CSVからExcelリスト作成。\n\nコピペ用プロンプト:\nPythonで顧客誕生日リスト自動作成のコードを作成してください。pandasライブラリを使ってCSVファイルからExcelリストを作成するコードを書いてください。初心者でも理解できるようにコメントを詳しく書いてください。"
    },
    {
        "id": 59,
        "category": "文書作成・管理",
